...
public class PurgeOldRecordsScheduler {
  @Getter(PRIVATE)
  private final StudentProfileRequestEmailEventRepository eventRepository;
  ...
  public PurgeOldRecordsScheduler(final StudentProfileRequestEmailEventRepository eventRepository) {
