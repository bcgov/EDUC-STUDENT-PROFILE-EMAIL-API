package ca.bc.gov.educ.api.student.email.controller;

import ca.bc.gov.educ.api.student.email.endpoint.StudentEmailEndpoint;
import ca.bc.gov.educ.api.student.email.exception.InvalidPayloadException;
import ca.bc.gov.educ.api.student.email.exception.errors.ApiError;
import ca.bc.gov.educ.api.student.email.model.*;
import ca.bc.gov.educ.api.student.email.service.StudentEmailService;
import ca.bc.gov.educ.api.student.email.validator.EmailValidator;
